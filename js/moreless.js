...
(function () {
  ...
  const FACTS = [
    ...
    { label: 'Antal dage på to uger', value: 14 },
    ...
    { label: 'Antal sekunder i et minut', value: 60 },
    ...
    { label: 'Antal timer i en uge', value: 168 },
    ...
    { label: 'Antal dage i et skudår', value: 366 },
    { label: 'Antal meter i en kilometer', value: 1000 },
    { label: 'Antal minutter i et døgn', value: 1440 },
